...
API_KEY = getenv("API_KEY", "xbit_ITDG1I6JWQWB7OQUFA7868") # youtube song api key, get it from https://t.me/MR_ROCKY_TZ
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/mrarya-bit/youtubebabysona2.0",
)
